...
function setup() {
  ...
  var myAnimation = ghost.addAnimation('floating', 'img/char1.png', 'img/char2.png');
  ...
  ghost.addAnimation('moving', 'img/char1.png', 'img/char2.png');

  ghost.addAnimation('spinning', 'img/char1.png', 'img/char2.png');
...
function draw() {
  ...
  if(mouseX < ghost.position.x - 100) {
